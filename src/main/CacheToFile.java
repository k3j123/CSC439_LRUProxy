 ...
 * @date 06/11/2011
 *
 * This is a simple class that write the cached web object (HTML) to file or
 * reads it. It also removes cached objects.
 *
 */
public class CacheToFile {
    ...
    /**
     * This reads the cached object that we retrieved and writes it to a file.
     *
     * @param url
     * @param sb
     */
    ...
    /**
     * Currently this reads the cached file And writes it to System.out.
     *
     * @param url
     */
    ...
    /**
     * This comes up with a filename, replacing any slashes with periods.
     *
